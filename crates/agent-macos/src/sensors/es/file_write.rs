// macos/sensors/es/file_write.rs
// ES_EVENT_TYPE_WRITE, ES_EVENT_TYPE_CLOSE(modified) → file write events
...
pub fn handle_write(
    ...
    // TODO: Parse ES write_event_t
    // Extract: path, bytes_written, pid, uid
    ...
    fields.insert("event".to_string(), json!("write"));

    Some(Event {
        ts_ms: ts_millis as i64,
        host: host.clone(),
        tags: vec!["macos".to_string(), "file".to_string(), "write".to_string()],
        proc_key: None,
